...
class StockResourceIT {
    ...
    public static Stock createEntity(EntityManager em) {
        Stock stock = new Stock().symbol(DEFAULT_SYMBOL).name(DEFAULT_NAME);
        return stock;
    }
    ...
    public static Stock createUpdatedEntity(EntityManager em) {
        Stock stock = new Stock().symbol(UPDATED_SYMBOL).name(UPDATED_NAME);
        return stock;
    }
    ...
    void putNewStock() throws Exception {
        ...
        updatedStock.symbol(UPDATED_SYMBOL).name(UPDATED_NAME);
    ...
    void fullUpdateStockWithPatch() throws Exception {
        ...
        partialUpdatedStock.symbol(UPDATED_SYMBOL).name(UPDATED_NAME);
